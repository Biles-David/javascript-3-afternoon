...
let david = new Employee ('David', 'Biles', 'fake@email.com', 24)
...
class ProgressiveManager {
  constructor (first, last, email, age, reports, title, bonus){
    this.first_name = first;
    this.last_name = last;
    this.email = email;
    this.age = age;
...
class Machine {
  ...
  makeWidgets(num){
    ...
    this.wear_and_tear_count = Number(this.widgets_made_count/50)
  }
  fixMachine(){
